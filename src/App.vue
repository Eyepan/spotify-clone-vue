      ...
      >
        <div class="flex items-center">
          <img
            class="rounded-full"
            width="27"
            src="https://lh3.googleusercontent.com/ogw/AAEL6sjpIHwl5eIgUk7GPPy09W_S-3cV5-ea2rAwPkSVz_w=s32-c-mo"
          />
          <div class="text-white text-[14px] ml-1.5 font-semibold">Pan</div>
          <ChevronDown
            v-if="!openMenu"
            @click="openMenu = true"
            fillColor="#FFFFFF"
